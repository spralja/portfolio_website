    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', portfolio_website.models.MarkdownField(blank=True)),
            ],
        ),
        migrations.CreateModel(
            name='Remote',
            fields=[
                ...
                ('object', models.CharField(default='main', max_length=255)),
            ],
        ),
        migrations.CreateModel(
            name='User',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='statics', to='main.project')),
            ],
        ),
        migrations.CreateModel(
            name='Resume',
        ...
        migrations.AddField(
            model_name='project',
            name='remote',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='main.remote'),
        ),
        migrations.AddField(
            model_name='project',
            name='user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='htmls', to='main.project')),
            ],
        ),
        migrations.CreateModel(
            name='Hobby',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='static_files', to='main.project')),
            ],
            options={
