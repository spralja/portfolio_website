...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.sqlite3' if os.environ['DB_ENGINE'] == 'True' else 'django.db.backends.sqlite3',
        'NAME': os.path.join(BASE_DIR, 'db.sqlite3') if os.environ['DB_ENGINE'] == 'True' else os.environ['DB_NAME'] ,
